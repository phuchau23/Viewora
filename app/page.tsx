...
import { ArrowRight, ChevronLeft, ChevronRight, Play, CalendarDays, Star, Clock, Tag } from "lucide-react";
                ...
                .map((movie) => (
                  <Card key={movie.id} className="overflow-hidden group">
                    <div className="relative aspect-[2/3] overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          <div className="flex gap-2 mb-2">
                            <Button size="sm" variant="outline" className="gap-1">
                              <CalendarDays className="h-3 w-3" /> {new Date(movie.releaseDate).toLocaleDateString("en-US", { month: "short", day: "numeric" })}
                            </Button>
                            <Button size="icon" variant="secondary" className="h-8 w-8">
                              <Play className="h-4 w-4" />
                            </Button>
                      ...
                      <Badge className="absolute top-2 right-2 bg-primary/90 hover:bg-primary">Coming Soon</Badge>
                    </div>
                    <CardContent className="p-4">
                      <h3 className="font-semibold truncate mb-1">
                        <Link href={`/movies/${movie.id}`} className="hover:text-primary">
